    ...
    <div name='support' className='w-full  mt-24'>
        ...
        <div className='max-w-[1240px] mx-auto text-white relative'>
            ...
            <div className='px-4 py-12'>
              <h2 className='text-3xl pt-2 text-slate-300 uppercase text-center'>Support</h2>
              <h3 className='text-5xl font-bold py-6 text-center'>Finding The Right Team</h3>
              <p className='py-4 text-3xl text-slate-300'>Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                 Repellendus dolorem molestias sed quam, tenetur autem provident deserunt,
                  explicabo non laboriosam placeat esse fuga soluta nam rerum,
                   distinctio rem consequatur nostrum.</p>
            </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              ...
              <div className='p-8'>
                ...
                <p className='text-gray-600 text-xl '>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Odio aliquid dolorem expedita sunt.
                   Ipsa nulla ducimus consequatur eaque consequuntur? Ea?</p>
